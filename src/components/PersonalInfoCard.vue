                                ...
                                <div class="col border-right">
                                  <div class="form-group mx-auto"> 
                                    ...
                                    <input
                                          ...
                                          class="form-control"
                                          name="email"
                                          :disabled="disabledEmail == 1"
                                          v-model="form.email"
                                          :placeholder="user.data.email"/>
                                    <div class="form-inline float-right my-2">
                                      <a class="btn btn-outline-info mr-2" title="Edit your email address"><b-icon icon="pencil"></b-icon></a>
                                      <a class="btn btn-outline-danger" title="Cancel your modification"><b-icon icon="x"></b-icon></a>
                                    </div>
                                  </div>
                                  <div class="form-group mx-auto my-5">
                                      <label for="displayName">Display Name:</label>
                                        <input
                                          ...
                                          name="displayName"
                                          :disabled="disabledDisplayName == 1"
                                        ...
                                        <div class="form-inline float-right my-2">
                                          <a class="btn btn-outline-info mr-2" title="Edit your display name"><b-icon icon="pencil"></b-icon></a>
                                          <a class="btn btn-outline-danger" title="Cancel your modification"><b-icon icon="x"></b-icon></a>
                                        </div>
                                  </div>
                                  <div class="form-group mx-auto my-5">
                                      <label for="photoURL">Photo Url:</label>
                                        ...
                                        <div class="form-inline float-right my-2">
                                          <a class="btn btn-outline-info mr-2" title="Change your Photo Url"><b-icon icon="pencil"></b-icon></a>
                                          <a class="btn btn-outline-danger" title="Cancel your modification"><b-icon icon="x"></b-icon></a>
                                        </div>
                                  </div>
                                </div>
                                <div class="col">
                                  <div class="form-group mx-auto"> 
                                      ...
                                      <input 
                                        ...
                                        class="form-control mx-auto"
                                        name="phoneNumber"
                                        :disabled="disabledPhoneNumber == 1"
                                  ...
                                  <div class="form-group mx-auto my-5">
                                      <label for="displayName">Address:</label>
                                        <input
                                  ...
                                  <div class="form-group mx-auto my-5">
                                      <label for="photoURL">Title:</label>
                                        <input
                                          v-if="!user.data.title"
                                          id="title"
                                          type="text"
                                          class="form-control mx-auto"
                                          name="title"
                                          :disabled="disabledTitle == 1"
                                          v-model="form.title"
                                          placeholder="Add your photo url here..."/>
                                        <input
                                          v-else
                                ...
                                <div class="container form-group mt-3">
                                    <div class="row form-inline mx-auto text-center">
                                        <div class="col mx-auto btn-lg btn-fluid " role="group" aria-label="Submit Group"> 
                                            <a class="btn btn-outline-info col-sm-5 mr-4"  @click.prevent="disabled = 0" v-if="disabled == 1"><b-icon icon="pencil"></b-icon> Edit</a>
                                            <a class="btn btn-outline-info col-sm-5 mr-4"  @click.prevent="onUpdateUser" v-else><b-icon icon="pencil"></b-icon> Save</a>
                                            <a class="btn btn-outline-danger col-sm-5"  @click.prevent="disabled = 1"><b-icon icon="x"></b-icon>Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
data() {
    return {
      ...
      disabledEmail: 1,
      disabledDisplayName: 1,
      disabledPhotoUrl: 1,
      disabledPhoneNumber: 1,
      disabledAddress: 1,
      disabledTitle: 1,
    }
  },
